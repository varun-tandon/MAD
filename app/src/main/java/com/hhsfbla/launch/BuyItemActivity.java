...
/**
 * Control logic for buying an item
 * @author Heidi
 */
...
public class BuyItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // keyboard should push up content
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);

        // get client token for using Paypal Braintree
    ...
    /**
     * gets client token generated by server, starting Braintree's Drop-In UI for payment
     */
    ...
    /**
     * finish transcation process
     * @param nonce - an arbitrary, unique string
     */
        ...
        client.post("http://mad2017.hhsfbla.com/braintree/checkout.php", params,
            new TextHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, String responseBody) {
                    ...
                    // show Success Dialog, see BuyItemSuccessDialog.java
                    ...
                    // delete item after it has been bought
